## Functions for the TaggingListScore class.

#' Print a TaggingListScore object.
#'
#' @param x the object to print
#' @param ...  additional parameters.
#' @export
print.TaggingListScore <- function(x,...) {
  NextMethod("print")
  cat("TaggingListScore, @maxFs: Ps/Rs/Fs Pl/Rl/Fl",
...
#' Initialize an object of type Tagging List Score
#'
#' @param x the object to initialize
#' @return the initialized object
initializeObject.TaggingListScore <- function(x) {
  obj <- x$data
...
#' Plot an object of type TaggingListScore
#'
#' @param show either "t" to show the threshold or "f" to show the f measure
plot.TaggingListScore <- function(x, strict=TRUE, show="t", ...) {
  if(strict) {
